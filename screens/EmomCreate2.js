...
export default function EmomCreate2({navigation, route}) {
const items = [
  ...
  return (
    <View style={styles.container} >
      ...
      <View style={styles.workoutname} >
        ...
        <ShortField placeholder="ex time"   >

</ShortField>
<ShortField placeholder="rest time"   >
        ...
        <View style={{marginBottom:20, flexDirection:'row', marginTop: 10}}>
            <ShortField placeholder="rounds"   >

</ShortField>
<ShortField placeholder="time"   >
